...
def main():
    ...
    parser.add_argument('--dna-purity', action="store_true", dest="dna_purity", required=False, default=False, help="Enabling DNA purity instead of default cell purity estimation")
